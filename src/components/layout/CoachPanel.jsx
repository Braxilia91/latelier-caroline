...
import { Send, Volume2, VolumeX, Trash2, Scissors, BookOpen } from 'lucide-react'

export default function CoachPanel({ coach, hasKey, currentChapter, chatHistory }) {
...
const styles = {
  ...
  iconBtn: {
    ...
    color: '#9C8878', cursor: 'pointer', transition: 'all .15s',
  },
  messages: {
  ...
  leaBubble: {
    background: '#FAF7F2', border: '1px solid #EDE7DE',
    borderRadius: '4px 14px 14px 14px',
    padding: '9px 13px',
    maxWidth: '85%',
    fontFamily: "'Lora', serif", fontStyle: 'italic',
    fontSize: '.83rem', lineHeight: 1.6, color: '#2A1A0E',
    whiteSpace: 'pre-wrap',
  },
  leaAvatar: {
    width: 26, height: 26,
  ...
  noKey: {
    ...
    borderTop: '1px solid #EDE7DE',
    background: '#F7EFE3',
    fontSize: '.78rem', color: '#8B6445', lineHeight: 1.5,
    textAlign: 'center',
  },
}
