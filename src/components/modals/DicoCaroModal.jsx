...
export default function DicoCaroModal({ onClose, coach, hasKey, currentChapter }) {
  ...
  const wikiPageUrl = wikiResult?.content_urls?.desktop?.page || ''
      ...
      <div style={S.modal}>
        ...
        <div style={S.body}>
          {tab === 'synonymes' && (
            <div style={S.form}>
              ...
              <div style={S.pills}>
                {[
                  ['simple', 'Simple & courant'],
                  ['mixte', 'Mixte (recommandé)'],
                  ['littéraire', 'Littéraire'],
                ].map(([v, l]) => (
                  <button
                    key={v}
                    style={{ ...S.pill, ...(level === v ? S.pillActive : {}) }}
                    onClick={() => setLevel(v)}
                  >
                    {l}
                  </button>
            ...
            <div style={S.form}>
              ...
              <div style={S.pills}>
                {[
                  ...
                  <button
                    key={v}
                    style={{ ...S.pill, ...(akinNature === v ? S.pillActive : {}) }}
                    onClick={() => setAkinNature(v)}
                  >
                    {l}
                  </button>
                ))}
              ...
              <div style={S.pills}>
                {[
                  ...
                  <button
                    key={v}
                    style={{ ...S.pill, ...(akinMouvement === v ? S.pillActive : {}) }}
                    onClick={() => setAkinMouvement(v)}
                  >
                    {l}
                  </button>
                ))}
              ...
              <div style={S.pills}>
                {[
                  ...
                  <button
                    key={v}
                    style={{ ...S.pill, ...(akinRegistre === v ? S.pillActive : {}) }}
                    onClick={() => setAkinRegistre(v)}
                  >
                    {l}
                  </button>
                ))}
            ...
            <div style={S.form}>
              ...
              <div style={{ display: 'flex', gap: 8 }}>
                ...
                <button
                  style={{
                    ...S.sendBtn,
                    opacity: wikiQuery.trim() && !wikiLoading ? 1 : 0.45,
            ...
            <div style={S.form}>
              <div style={S.akinatorCard}>
                ...
                <p style={S.akinatorSub}>
                  Léa analyse ce que tu es en train d'écrire et prédit les mots dont tu pourrais
                  avoir besoin dans les prochains paragraphes.
                </p>
                ...
                {hasChapterContent && (
                  <p style={{ ...S.akinatorSub, color: '#6B8F71', fontStyle: 'italic' }}>
                    Ton chapitre est prêt — Léa va analyser ton style et anticiper les prochains
                    mots dont tu pourrais avoir besoin.
                  </p>
                )}
              </div>
            </div>
          ...
          {tab === 'conseil' && (
            <div style={S.form}>
              <div style={S.akinatorCard}>
                ...
                <p style={S.akinatorSub}>
                  Léa choisit un mot rare, une tournure stylistique ou une figure de style que tu
                  pourrais intégrer dans ton écriture autobiographique.
                </p>
        ...
        {showFooter && (
          <div style={S.footer}>
            {!hasKey && (
              <p style={S.noKey}>
                Configure ta clé API Anthropic dans les réglages pour activer Léa.
              </p>
            )}
